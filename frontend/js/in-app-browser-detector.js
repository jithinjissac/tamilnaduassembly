    ...
    function showOpenInBrowserModal() {
        ...
        modal.innerHTML = `
            ...
            <p style="color: #666; font-size: 15px; margin: 0 0 20px 0;">
                <strong>This website requires a full browser.</strong><br>
                The ${browserName} in-app browser has limited functionality and security issues.
            </p>
            ${autoOpenMessage}
            ${instructions}
            <div style="margin-top: 25px; display: flex; flex-direction: column; gap: 12px;">${isAndroid ? `
            ...
            <p style="color: #999; font-size: 11px; margin: 15px 0 0 0;">
                Some features like payments and downloads may not work in ${browserName} browser.
            </p>
        `;
